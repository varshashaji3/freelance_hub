    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resolution_status', models.CharField(blank=True, choices=[('Satisfactory', 'Satisfactory'), ('Unsatisfactory', 'Unsatisfactory'), ('Pending', 'Pending')], default='Pending', max_length=15, null=True)),
