web: python manage.py makemigrations && python manage.py migrate && \
     ...
     python -c "from django.contrib.sites.models import Site; Site.objects.update_or_create(id=1, defaults={'domain': 'freelancehub-production.up.railway.app', 'name': 'FreelanceHub'})" && \
